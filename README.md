...
<h2>4.1. Функциональный интерфейс команды</h2>

- Command - интерфейс для функционирования

<h2>4.2. Класс системы RBAC</h2>

- RBACSystem - класс с менеджерами пользователя, ролей и назначения и имя текущего пользователя-администратора системы (для метаданных)
